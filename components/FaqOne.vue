        ...
        <div class="col-xl-6 col-lg-6">
          <div class="faq_one_left">
            ...
            <div
              class="faq_one_image"
              style="
                background-image: url(/assets/images/resources/faq_one_img-1.jpg);
              "
            >
              <div class="phone_number">
                <p>
                  If you have emergency call nows<a href="tel:888-999-0000"
                    >666 888 0000</a
                  >
                </p>
              </div>
                ...
                <div class="ac">
                  ...
                  <div class="ac-a accordion__content">
                    <p class="accordion__content-desc">
                      ...
                      Vestibulum leo ligula, molestie ullamcorper vulputate
                      vitae sodales commodo nisl. Nulla facilisi. Pellentesque
                      est metus many of eration in some form.
                    </p>
                  </div>
                </div>
